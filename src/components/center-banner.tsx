...
export default function CenterBanner() {
  return (
    <section className="relative overflow-hidden" aria-label="TM Center München">
      {/* Container — aspect ratio controls how much of the image is visible.
      ...
      <div className="relative aspect-[3/2] sm:aspect-[16/7] w-full">
        ...
        {/* Gradient overlay — subtle at top, stronger at bottom for text */}
